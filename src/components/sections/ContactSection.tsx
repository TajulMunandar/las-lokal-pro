...
const ContactSection = () => {
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      label: "Email",
      value: "info@bengkellaspro.com",
      href: "mailto:info@bengkellaspro.com",
    },
    {
      icon: MapPin,
      label: "Alamat",
      value: "Jl. Industri Raya No. 123, Jakarta Barat, Indonesia 11620",
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="rounded-xl overflow-hidden border border-border h-[300px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253840.65295081942!2d106.6894324!3d-6.229386!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta%2C%20Indonesia!5e0!3m2!1sen!2sus!4v1640000000000!5m2!1sen!2sus"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Lokasi Bengkel Las Profesional"
              />
            </div>
          </div>
